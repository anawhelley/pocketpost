...
function preload() {
  flower1 = loadImage('animal-13.png');
  flower2 = loadImage('animal-14.png');
  flower3 = loadImage('animal-15.png');
  flower4 = loadImage('animal-16.png');
  flower5 = loadImage('animal-17.png');
  flower6 = loadImage('animal-18.png');
  bg = loadImage('ocean.jpeg')
}
...
function mousePressed() {
  ...
  if (flowerno == 0){
      image(flower3, mouseX-100, mouseY-100, 250,250);
  }
    
  if (flowerno == 1){
      image(flower1, mouseX-90, mouseY-100, 170,150);
  }

  if (flowerno == 2){
     image(flower5, mouseX-100, mouseY-80, 180,150);
  }
    
  if (flowerno == 3){
      image(flower6, mouseX-150, mouseY-110, 300,300);
  }
    
  if (flowerno == 4){
      image(flower2, mouseX-40, mouseY-60, 100,100);
  }
    
  if (flowerno == 5){
      image(flower4, mouseX-100, mouseY-100, 230,200);
  }
