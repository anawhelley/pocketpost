...
function preload() {
  flower1 = loadImage('animal-01.png');
  flower2 = loadImage('animal-02.png');
  flower3 = loadImage('animal-03.png');
  flower4 = loadImage('animal-04.png');
  flower5 = loadImage('animal-05.png');
  flower6 = loadImage('animal-06.png');
  bg = loadImage('feild.jpeg')
}
...
function mousePressed() {
  ...
  if (flowerno == 2){
     image(flower1, mouseX-80, mouseY-120, 230,200);
  }
